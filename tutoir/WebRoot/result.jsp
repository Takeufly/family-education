...
<html>
 ...
 <body>	
 <%
 		List<TutorInfo> list=(List<TutorInfo>)request.getAttribute("info");
  %>
  ...
  <div class="col-md-12">
		<div class="col-md-8 col-md-offset-2" id="result">
			<%for(TutorInfo info:list){ 
			 %>
			<div class="col-md-3 result-div">
				<a href="QueryPerson?logname=<%=info.getTlogname() %>" ></ea><img src="http://localhost:8080/tutor/Upload/564io/564io.jpg" class="result-img">
				<div class="logname">
					<input type="hidden" value="<%=info.getTlogname()%>"/>
				</div>
				<div class="name">
					<span class="theinfo">姓名:</span><span><%=info.getTname()%></span>
				</div>
				<div class="college">
					<span class="theinfo">学校:</span><span><%=info.getTcollege()%></span>
				</div>
				<div class="tutorinfo">
					<span class="theinfo">简介:</span><span><%=info.getInfo()%></span>
				</div>
			</div>
			<%
				}
